...
Given I can see a concluded service of the service provider with id "1"
Given I can see the button Add a review of the service provider with id "1"
When I click on the button Add a review of the service provider with id "1"
Then I can see the evaluation dialog

Scenario: Evaluating the service provider
Given I am at the evaluation dialog of the service provider with id "1"
...
Then The evaluation dialog of the service provider with id "1" closes

Scenario: List the previows evaluations of a service provider
Given I am at the To contract page of the service provider with id "1"
