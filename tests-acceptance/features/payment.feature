Feature: as a customer
    ...
    Scenario: Payment failure, wrong cvv
        Given I am on the "Payment" page with provider id "3"
        When I enter my credit card informations, with cardholder name "Sergio Soares" card number "1111222233334444" expiration month "11" expiration year "2025" cvv "102"
        When I confirm the payment
        Then a error message is shown

    Scenario: Payment failure, wrong credit card number
        Given I am on the "Payment" page with provider id "3"
        When I enter my credit card informations, with cardholder name "Sergio Soares" card number "1111222233334449" expiration month "11" expiration year "2025" cvv "101"
        When I confirm the payment
        Then a error message is shown
